...
from components import sequence, attention, BucketedDataIterator
...
if __name__=="__main__":
    ...
    emb_matrix = np.load(emb_filename)
    ...
    with tf.Session() as sess:
        ...
        print("avg cost in the training phase: {}".format(avg_cost))
        ...
        for i in range(total_batch2):
            ...
            a = inputs 
            b = sess.run(a, feed_dict={inputs:batch_x})
